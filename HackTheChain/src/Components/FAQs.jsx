...
//     answer: "Accommodation and travel may be sponsored for select participants.",
//   },
//   {
//     id: 6,
//     question:
...
//       <h1 className="text-3xl sm:text-xl md:text-2xl lg:text-6xl font-bold text-white text-center mb-10 newfont">
//         FAQs
//       </h1>
...
//           <div
//             key={faq.id}
//             className={`w-full max-w-2xl bg-opacity-70 rounded-lg p-4 cursor-pointer transition-all duration-300 overflow-hidden shadow-lg ${
...
//                   activeFaq === faq.id ? "rotate-0" : "rotate-0"
//                 }`}
//               >
//                 +
//               </span>
...
//                 <p className="text-base text-[#b0e3ff]">{faq.answer}</p>
//               </div>
//             )}
//           </div>
//         ))}
        ...
        {faqsData.map((faq) => (
          ...
          >
            <div className="flex justify-between items-center text-lg">
              ...
              <span
                className={`text-2xl transition-transform duration-300 ${
                  activeFaq === faq.id ? "rotate-45" : "rotate-0"
                }`}
              >
                +
              </span>
