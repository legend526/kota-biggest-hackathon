        ...
        <div className="flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/iiitkota_codebase?igsh=cThlM2FxODkxZnVq" className="text-gray-400 hover:text-green-400 text-2xl relative z-10">
                <i className="fab fa-instagram"></i>
              </a>
              <a href="https://www.linkedin.com/company/codebase-iiitkota/posts/?feedView=all" className="text-gray-400 hover:text-green-400 text-2xl relative z-10">
                <i className="fab fa-linkedin"></i>
              </a>
              <a href="https://discord.com/invite/3dUMG3dB5F" className="text-gray-400 hover:text-green-400 text-2xl relative z-10">
                <i className="fab fa-discord"></i>
              </a>
              <a href="https://twitter.com/iiitkcodebase" className="text-gray-400 hover:text-green-400 text-2xl relative z-10">
          ...
          <div>
            ...
            <ul className="space-y-2 font-serif">
              <li><a href="#home" className="text-gray-400 hover:underline relative z-10">Home</a></li>
              <li><a href="#about-us" className="text-gray-400 hover:underline relative z-10">About Us</a></li>
              <li><a href="#timeline" className="text-gray-400 hover:underline relative z-10">Timeline</a></li>
              <li><a href="#stats" className="text-gray-400 hover:underline relative z-10">Stats</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 font-serif">
              ...
              <li><a href="tel:+917877857168" className="text-gray-400 hover:underline relative z-10"> +91 7877857168 </a></li>
            </ul>
          </div>
        </div>
      </div>
